...
//    NSLog(self.webView);
    //NSLog(@"calling runJS");
    NSString *returnvalue = [self.webView stringByEvaluatingJavaScriptFromString:@"window.InherentVice.viceTrigger('hello world')"];
    //NSLog(returnvalue);
...
//        [NSNotificationCenter send:@"Error sending trigger"];
//    }
}
...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    [self performSelector:@selector(runJS) withObject:nil afterDelay:9.0];
    [self performSelector:@selector(runTrigger) withObject:nil afterDelay:15.0];
